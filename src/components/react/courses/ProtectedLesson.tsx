...
export function ProtectedLesson({ courseSlug, lessonSlug, videoId, isFree, children }: Props) {
    ...
    return (
      <div className="aspect-video bg-dark-800 border border-white/10 rounded-2xl flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <p className="text-gray-400 mb-6">Necesitas una cuenta para acceder a esta lección</p>
          <a
            href="/login"
      ...
      <div className="aspect-video bg-dark-800 border border-white/10 rounded-2xl flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <p className="text-gray-400 mb-6">
            Esta lección requiere acceso al curso completo
          </p>
          <a
            href="#contact"
