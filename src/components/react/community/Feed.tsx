...
export function Feed({ courseSlug, courseTitle }: Props) {
  ...
  if (!hasAccess) {
    return (
      <div className="bg-dark-800 border border-white/10 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-400 mb-6">La comunidad esta disponible para estudiantes del curso</p>
        <a
  ...
  return (
    <div>
      ...
      <CreatePost courseSlug={courseSlug} onPostCreated={loadPosts} />
