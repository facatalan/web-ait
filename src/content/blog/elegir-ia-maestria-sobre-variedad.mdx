...
1. **Mover información entre apps**: Copiar y pegar contexto, reformatear datos, subir archivos de nuevo. Trabajo que no existiría si usaras una sola herramienta.

2. **Re-explicar contexto**: Cada IA nueva es una pizarra en blanco. Le tienes que explicar quién eres, qué estás trabajando, cuál es el contexto del proyecto. Multiplicado por 7 herramientas, es agotador.
